...
function DeviceIcon({ name }: { name: Guide["icon"] }) {
    ...
    switch (name) {
        ...
        case "android":
            return (
                <svg {...common}>
                    <path d="M7 16V9a5 5 0 0110 0v7" />
                    <path d="M5 16h14v3a1 1 0 01-1 1H6a1 1 0 01-1-1z" />
                    <path d="M8 6L6.5 4M16 6l1.5-2" />
        ...
        case "apple":
            return (
                <svg {...common}>
                    <path d="M16 13.5c0 2.5 2 3.3 2 3.3s-1.4 3.7-3.2 3.7c-1 0-1.4-.6-2.5-.6s-1.6.6-2.5.6c-1.9 0-3.8-3.9-3.8-6.9 0-3 2-4.6 3.7-4.6 1.1 0 1.8.7 2.6.7.8 0 1.3-.7 2.6-.7 1 0 2 .5 2.7 1.4-2.4 1.3-1.9 4.1-1.6 3.6z" />
                    <path d="M13 5.5C13.6 4.7 14 3.7 13.9 2.7c-.9.1-1.9.6-2.5 1.4-.5.6-1 1.6-.8 2.6.9.1 1.9-.4 2.4-1.2z" />
                </svg>
            );
        case "tv":
            return (
    ...
    return (
        <div className="setup-page">
            <div className="container">
                ...
                <header className="setup-header">
                    ...
                    <p className="setup-subtitle">
                        Get streaming in minutes. Follow the step-by-step instructions for your device below, or
                        reach out to our team for live assistance.
                    </p>
                </header>
                ...
                <nav className="device-nav" aria-label="Devices">
                    {guides.map((g) => (
                        <a key={g.id} href={`#${g.id}`} className="device-chip">
                ...
                <div className="device-grid">
                    {guides.map((g) => (
                        <section key={g.id} id={g.id} className="device-card card" aria-labelledby={`${g.id}-title`}>
                            <div className="device-card-head">
                                <span className="device-icon" aria-hidden="true">
                                    <DeviceIcon name={g.icon} />
                                </span>
                                <span className="device-label">{g.label}</span>
                            </div>
                            <h2 id={`${g.id}-title`} className="device-title">
                                {g.title}
                            </h2>
                            <p className="device-intro">{g.intro}</p>
                ...
                {/* Closing CTA */}
                <section className="setup-cta card" aria-label="Get help">
                    <h2 className="cta-title">Need a hand?</h2>
                    <p className="cta-text">
                        If you run into any issues during installation, our team is on standby. Get live support or
            ...
            <style>{`
                ...
                .device-chip svg { color: var(--primary); }
